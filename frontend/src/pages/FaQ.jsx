...
function FaQ() {
  ...
  return (
    <>
      ...
      <section
        className="bg-gray-100 noise-bg relative hidden md:flex flex-col xsh-landscape:min-h-[60vh] min-h-[70vh] xh:min-h-[40vh] xsh:min-h-[50vh] xhh:min-h-[40vh] md:flex-row"
      >
        <div className="flex flex-col w-full justify-between md:justify-around md:flex-row max-w-[1700px] mx-auto">
          {/* Text Section */}
          <div className="relative flex flex-col lg:mt-16  xl:mt-12 xhh-landscape:-mt-10  xsh:mt-12 justify-center items-start  md:pl-1 md:p-0 lg:ml-16 md:ml-10 xl:ml-16 md:mb-40">
            <h1
      ...
      <section
        className="py-8 md:py-12 lg:py-10 px-6 bulge-top-other md:px-8 noise-bg-neww md:noise-bg-newwee -mt-4 md:-mt-16 lg:-mt-20 xl:-mt-28 z-10"
      >
