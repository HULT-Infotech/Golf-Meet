...
import bgPrizee from "../assets/GolfPrize/bgPrize.webp";
...
>
  VIETNAM
    ...
    <div className="relative w-full -mt-12  xsm:h-[40vh] xh:h-[50vh]  xhh:h-[50vh] md:block hidden">
    ...
    >
      VIETNAM
        ...
        <div className="w-full h-[77vh] xh:h-[40vh] xhh:h-[40vh] xhhh:h-[60vh] xsh:h-[50vh] overflow-hidden md:block hidden">
        ...
        <div className="w-full min-h-[70vh] -mt-24 bg-white relative md:block hidden">
