  ...
  return (
    <>
      ...
      <section className="relative bg-gray-100 noise-bg min-h-[90vh] w-full overflow-hidden flex flex-col justify-between p-4 sm:p-6 md:p-8 text-center">
        ...
        <h2 className="text-sm md:text-lg lg:text-2xl uppercase tracking-wide my-4 md:my-6 lg:my-10">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-7xl mx-auto uppercase py-2 md:py-4 font-quattrocento tracking-wider font-bold mt-2">
            The GolfMeet
            <br />
        ...
        <p className="mt-4 text-[#014D4E] text-xl md:text-2xl xl:text-3xl my-4 md:my-6 lg:my-10 mx-auto max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
      ...
      <section className="text-center flex flex-col justify-center p-4 sm:p-8 md:p-12 lg:p-16 xl:p-20 w-full max-w-full overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-8 w-full overflow-x-auto">
          {[
            ...
            <article
              key={index}
              className="w-full max-w-xs h-auto min-h-64 md:w-64 lg:w-72 flex flex-col justify-evenly border-2 rounded border-black p-4 md:p-6 lg:p-8 mb-4 md:mb-0 transition-all duration-300 hover:border-transparent hover:bg-[linear-gradient(to_bottom_right,#0d8488_0%,#014D4E_100%)] hover:text-white group"
            >
