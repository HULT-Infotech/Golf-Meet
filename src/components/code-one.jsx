...
import tr_bg_mobile from "../assets/checkk.svg";
...
function CodeOne() {
  return (
    <div className="md:overflow-visible overflow-hidden">
      ...
      <h1 className="font-quattrocento font-bold xsm:text-[2.3rem] text-[2.9rem] text-[#201E15] sm:text-5xl lg:text-[80px] pt-8 leading-[100%] tracking-[0.025em] mb-4"
      style={{
      ...
      <div className="xsm:text-xs text-sm md:hidden mb-4 xsm:w-[85%] w-[95%]">Golf Meet is built on respect, trust, and the spirit of true sportsmanship. Review the player code that defines our community.


      </div>
      <p className="font-semibold xsm:text-xs text-sm xsm:w-[85%] w-[95%]">

And if you have suggestions, we’re always ready to listen.</p>
    </div>
        ...
        <div className="absolute bottom-0 left-0 w-full">
          ...
          <img
            ...
            className="w-[93%]  object-contain pointer-events-none md:hidden"
          />
        </div>
      </section>
