...
const CompletePage = () => {
  return (
    <>
      <div className="md:hidden mx-auto relative bg-gray-100 -mt-8 noise-bg-n z-10 pt-10 md:py-20">
      ...
      <div className="hidden md:block mx-auto relative  -mt-8 noise-bg-optim z-10 pt-10 md:pt-16 lg:pt-24">
