          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col p-4 mt-4">
                ...
                <button 
                  className="text-[#211E16] pl-6 font-bold pb-6 pt-3 text-left border-b border-gray-300 hover:bg-gray-200 flex items-center"
                  onClick={(e) => {
                    e.stopPropagation();
                    handleWhatsAppClick(e);
                    setSidebarOpen(false);
                ...
                >
                  PLAYER SUPPORT <span className="ml-2">
