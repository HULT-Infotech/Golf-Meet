...
function VideoSection() {
  return (
    <>
      <section className="bg-[#014D4E] h-auto noise-bg-new flex flex-col items-center justify-center pt-24 md:p-20 relative clip-slant z-20">
        {/* Video player container with border */}
  
        {/* Tagline and description for MEET and PLAY */}
        <div className="text-center text-white py-0">
          <h2 className="text-5xl flex flex-col md:flex-row justify-center items-center gap-5 font-quattrocento md:text-5xl lg:text-6xl font-bold tracking-wider">
            MEET
            <p className="text-sm opacity-90 block md:hidden">Meet new golfers <br /> in your area.</p>
            <svg
              width="13"
              height="14"
              viewBox="0 0 13 14"
            ...
            PLAY
            <p className="text-sm opacity-90 block md:hidden">
