...
{/* Section ABOVE the green part with noise background */}
{/* Wave section */}
<section className="w-full h-[200px] relative -mt-60 z-0 overflow-hidden">
  ...
  >
    <path
      d="M0,30 C360,60 720,25 1080,35 C1260,40 1350,50 1440,75 L1440,100 L0,100 Z"
      fill="#014D4E"
    />
  </svg>
</section>
...
{/* Main green section */}
<section className="bg-[#014D4E] w-full min-h-[70vh] px-10 md:px-20 flex items-center justify-center relative z-10">
