...
function DesktopTabletLandingPage() {
  ...
  return (
    <section className="text-center">
      {/* First section */}
      <div className="relative flex flex-col min-h-[72vh] xh:min-h-[50vh] bg-gray-50 z-0 noise-bg overflow-hidden">
        {/* Top Navbar */}
        ...
        <div className="md:flex hidden relative md:min-h-[74vh] lg:min-h-[72vh] xh:min-h-[50vh] flex-col w-full items-center justify-center">
          ...
          >
            <img
              ...
              alt="Golfmeet Logo"
              className="w-48 object-contain md:w-[300px] xh:w-[380px] lg:w-[340px] xl:w-[31vw] xl:-mt-5 drop-shadow-[0_10px_10px_rgba(0,0,0,0.40)]"
              draggable="false"
            />
          </div>
        </div>
      ...
      {/* Second section */}
      <section className="relative xl:h-[113vh] lg:h-[100vh] md:h-[78vh] xh:h-[60vh] bulge-top-desk -mt-8 z-10 w-full overflow-hidden noise-bg-newest">
      
        {/* Content positioned above the image */}
        <div className="relative z-20 max-w-xl  mx-auto px-4">
          {/* First Section */}
          <div>
            <h1 className="text-[40px] mt-10 xh:text-[3.6rem] md:text-[48px] lg:text-[61px]  xh:mt-8 leading-tight tracking-normal text-center font-quattrocento font-bold">
              <span style={{
          ...
          <div className="flex flex-col items-center justify-center py-10 md:py-5 lg:py-3 xh:py-2">
            <p className="font-quattrocento text-[24px] md:text-[23.5px] lg:text-[28px] xh:text-[25px] leading-tight tracking-normal text-center text-white">
              PLAY BETTER.
            </p>
          </div>
          ...
          {/* Third Section */}
          <div>
            <p className="font-extrabold font-quattrocento md:text-3xl lg:text-[2.5rem] xh:mt-16 xh:text-[2.4rem] drop-shadow-lg lg:leading-[2.8rem] tracking-normal lg:mt-20 xl:mt-44 md:mt-4  bg-gradient-to-b from-[#FFF2BF] to-[#F4D455] text-transparent bg-clip-text text-center">
              Golf Meet matches you with <br /> new golfers every round.
            </p>
            <p className="font-quattrocento font-normal lg:text-[20px] md:text-[17px] xh:text-[18px] leading-normal tracking-normal text-center text-[#FFFFFF] opacity-70 mt-3 xh:mt-2">
              Players are matched based on <br /> their preferred courses and dates. 
            </p>
            
            {/* Register Button */}
            <div className="flex justify-center md:mt-7 lg:mt-12 xh:mt-8">
              <Link 
                to="/redirect"
              ...
              >
                <span className="text-[20px] md:text-sm lg:text-base xh:text-[15px] font-quattrocento text-[#014D4E] font-bold uppercase">
