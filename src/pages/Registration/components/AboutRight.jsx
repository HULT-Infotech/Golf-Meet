      ...
      <div className="max-w-auto mx-auto w-full">
        ...
        <div className="mb-6 lg:mb-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            A few words to break ice with your fellow golfers, you can share your interests, or what drives you.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative w-full lg:max-w-md">
              <textarea
                ...
                className="w-full px-4 py-3 lg:py-4 text-base border-2 border-[#014D4E] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#014D4E] focus:border-transparent resize-none"
                placeholder="I'm Rohan, a product manager with 8+ years of experience in building customer-first digital platforms. I'm passionate about solving real problems through thoughtful innovation."
                rows={4}
                maxLength={500}
              />
            </div>
            ...
            <div className="mt-2 text-xs text-gray-500">
              {fullName.length} of 500 characters
            </div>
